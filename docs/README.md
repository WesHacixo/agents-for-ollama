...
| [BIS-CP0 pattern alignment](portfolio-integration/bis-cp0-pattern-alignment.md) | Manifest checksums, layered verify, governance e2e (pattern source only) |
| **[TS governance architecture (ADR)](portfolio-integration/detached-membrane-governance-ts-architecture.md)** | **Polyglot plan** — TS governance spine + Python executor · [Epic #1](https://github.com/WesHacixo/agents-for-ollama/issues/1) |
